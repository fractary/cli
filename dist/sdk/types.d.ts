...
export interface WorkManager {
    ...
    updateIssue(number: number, data: {
        title?: string;
        body?: string;
    }): Promise<Issue>;
...
export interface RepoManager {
    ...
    deleteBranch(name: string, params?: {
        location?: string;
        force?: boolean;
    }): Promise<void>;
    listBranches(params?: {
    ...
    reviewPR(number: number, params: {
        action: string;
        comment?: string;
    }): Promise<void>;
    mergePR(number: number, params?: {
        strategy?: string;
    ...
    createTag(name: string, params?: {
        message?: string;
        sign?: boolean;
    }): Promise<Tag>;
    pushTag(name: string, params?: {
        remote?: string;
    }): Promise<void>;
    listTags(params?: {
        pattern?: string;
    ...
    createWorktree(branch: string, params?: {
        workId?: string;
    }): Promise<Worktree>;
    listWorktrees(): Promise<Worktree[]>;
    removeWorktree(branch: string, params?: {
        force?: boolean;
    }): Promise<void>;
